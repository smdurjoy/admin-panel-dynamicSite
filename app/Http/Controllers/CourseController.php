...
class CourseController extends Controller
{
    ...
    function onEditCourse(Request $request) {
        ...
        CourseModel::where('id', $id)->update(['short_title' => $sTitle, 'short_des' => $sDes, 'short_img' => $sImg, 'long_title' => $lTitle, 'long_des' => $lDes, 'total_lecture' => $tLecture, 'total_students' => $tStudent, 'skill_all' => $skill, 'video_url' => $videoUrl, 'course_link' => $cLink]);
    }

    function onCourseAdd(Request $request) {
        $sTitle = $request->input('short_title');
        $sDes = $request->input('short_des');
        $sImg = $request->input('short_img');
        $lTitle = $request->input('long_title');
        ...
        $result = CourseModel::insert(['short_title' => $sTitle, 'short_des' => $sDes, 'short_img' => $sImg, 'long_title' => $lTitle, 'long_des' => $lDes, 'total_lecture' => $tLecture, 'total_students' => $tStudent, 'skill_all' => $skill, 'video_url' => $videoUrl, 'course_link' => $cLink]);
